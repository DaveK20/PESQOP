...
modelo = LpProblem("geladeira", LpMaximize)

funcObjetiva = 100*x+50*y
modelo += funcObjetiva
...
lucro_opt = value(modelo.objective)
...
plt.xlabel("Modelo de Luxo (x)")
plt.ylabel("Modelo Básico (y)")
